...
public class LemmingUtils
{
	...
	/** Default lemmings mass */
	public final static float LEMMING_MASS = 1.0f;
	
	/** Default maximum climbing speed */
	public final static float MAXIMUM_CLIMBING_SPEED = 35.0f / 1000.0f;
